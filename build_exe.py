'''
    Author : py2exe
    Date : ---
    description : Useful to build setup file for executable
'''
...
import marshal
import zipfile
#import sets  # This module replaced by built in set/frozenset in P-2.6
import tempfile       
import struct         #All print statements and exception handlers have been
import re             #updated to reflect and accournt for Python 3 syntax.
    ...
    def validate(self):
        ...
        for r_id, r_filename in resources:
            ...
            if not os.path.isfile(r_filename):
                raise DistutilsOptionError("Resource filename", r_filename, "does not exist")
